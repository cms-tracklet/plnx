...
C_SRCS += \
/mnt/scratch/wittich/tracklet/plnx/XU3_EB1/xupl/components/plnx_workspace/fsbl_hwproj/psu_init.c \
...
src/psu_init.o: /mnt/scratch/wittich/tracklet/plnx/XU3_EB1/xupl/components/plnx_workspace/fsbl_hwproj/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM A53 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O2 -I"/mnt/scratch/wittich/tracklet/plnx/XU3_EB1/xupl/components/plnx_workspace/fsbl_hwproj" -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I../../fsbl_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
